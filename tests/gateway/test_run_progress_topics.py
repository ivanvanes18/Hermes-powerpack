...
@pytest.mark.asyncio
async def test_terminal_progress_inline_format_avoids_fenced_code_block(monkeypatch, tmp_path):
    """Telegram can opt out of copy-code blocks and keep terminal progress as

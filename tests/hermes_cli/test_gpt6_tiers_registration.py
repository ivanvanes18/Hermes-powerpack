...
GPT6_TIERS = ("gpt-6-sol", "gpt-6-luna")  # only the published Sol/Luna tiers
...
def test_gpt6_tiers_replace_56_in_aggregator_catalogs_with_pricing_aliases():
    ...
    for base in ("gpt-6-sol", "gpt-6-luna"):  # only published tiers have pricing
...
def test_codex_forward_compat_only_synthesizes_published_gpt6_tiers():
    ...
    must stay within the published Sol/Luna tiers (astra is discovery-only)."""

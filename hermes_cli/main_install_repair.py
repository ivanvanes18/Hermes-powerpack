...
_CONFIGURED_FEATURES_SCRIPT = (
    ...
    "    _cfg = load_config()\n"
    "    _feishu = (_cfg.get('platforms') or {}).get('feishu') or {}\n"
    "    if 'lark_oapi' in sys.modules and sys.modules['lark_oapi'] is None and _feishu.get('enabled'):\n"
    "        print('Feishu / Lark\\tinstall the %r extra' % 'feishu')\n"
    "except Exception:\n"
    "    pass\n"
    "try:\n"
    "    from gateway.config import load_gateway_config\n"
    "    from gateway.platform_registry import platform_registry\n"
    "    _forced_feishu_missing = 'lark_oapi' in sys.modules and sys.modules['lark_oapi'] is None\n"
    "    for platform in load_gateway_config().get_connected_platforms():\n"
    "        if _forced_feishu_missing and platform.value == 'feishu':\n"
    "            continue\n"
    ...
    "try:\n"
    "    from hermes_cli.config import load_config\n"
    "    if (load_config().get('mcp_servers') or {}):\n"
    "        mcp_module = sys.modules.get('mcp')\n"
    "        if mcp_module is None or importlib.util.find_spec('mcp') is None:\n"

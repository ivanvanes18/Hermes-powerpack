---
title: "Webd — Design conversion-focused web interfaces"
sidebar_label: "Webd"
...
Design conversion-focused web interfaces.
...
- **[Design Framework](https://github.com/NousResearch/hermes-agent/blob/main/skills/webd/references/design-framework.md)** - Establish aesthetic direction BEFORE coding
- **[Conversion Patterns](https://github.com/NousResearch/hermes-agent/blob/main/skills/webd/references/conversion-patterns.md)** - Landing page optimization from Landing Pages Explained
- **[UI Libraries](https://github.com/NousResearch/hermes-agent/blob/main/skills/webd/references/ui-libraries.md)** - 17+ shadcn/ui-based component libraries
- **[DESIGN.md / DESIGNmd token extraction](https://github.com/NousResearch/hermes-agent/blob/main/skills/webd/references/designmd-reference-token-extraction.md)** - fallback + token-role workflow for applying published design kits
...
1. **Read [design-framework.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/webd/references/design-framework.md)** for full process
...
1. **Read [conversion-patterns.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/webd/references/conversion-patterns.md)** for full patterns

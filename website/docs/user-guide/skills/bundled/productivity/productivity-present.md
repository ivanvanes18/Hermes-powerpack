---
title: "Present — Generate polished HTML presentations"
sidebar_label: "Present"
...
Generate polished HTML presentations.
...
| Path | `skills/productivity/present` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `presentation`, `slides`, `html`, `reports`, `documents` |
| Related skills | [`powerpoint`](../../bundled/productivity/productivity-powerpoint.md), [`google-workspace`](../../bundled/productivity/productivity-google-workspace.md) |
...
## References
- [Modes](https://github.com/NousResearch/hermes-agent/blob/main/skills/productivity/present/references/modes.md)
- [Slides authoring](https://github.com/NousResearch/hermes-agent/blob/main/skills/productivity/present/references/slides-authoring.md)
- [Quick test checklist](https://github.com/NousResearch/hermes-agent/blob/main/skills/productivity/present/references/quick-test-checklist.md)
- [Manual review checklist](https://github.com/NousResearch/hermes-agent/blob/main/skills/productivity/present/references/manual-review-checklist.md)
- [Backward-compat map](https://github.com/NousResearch/hermes-agent/blob/main/skills/productivity/present/references/backward-compat-map.md)

---
title: "Piapi Video Toolkit — Plan PiAPI video generation workflows"
sidebar_label: "Piapi Video Toolkit"
description: "Plan PiAPI video generation workflows"
---
...
Plan PiAPI video generation workflows.
...
| Path | `skills/media/piapi-video-toolkit` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `piapi-video-toolkit` |
